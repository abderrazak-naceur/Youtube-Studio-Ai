...
#pragma warning disable 612, 618
        ...
        {
            b.Property<Guid>("Id").HasColumnType("uuid"); b.Property<Guid>("WorkspaceId").HasColumnType("uuid"); b.Property<Guid>("ResearchProjectId").HasColumnType("uuid"); b.Property<string>("Text").IsRequired().HasMaxLength(20000).HasColumnType("character varying(20000)"); b.Property<string>("VerificationStatus").IsRequired().HasMaxLength(50).HasColumnType("character varying(50)"); b.Property<string>("MetadataJson").IsRequired().HasMaxLength(200000).HasColumnType("character varying(200000)"); b.Property<DateTime>("CreatedAtUtc").HasColumnType("timestamp with time zone"); b.Property<DateTime>("UpdatedAtUtc").HasColumnType("timestamp with time zone"); b.HasKey("Id").HasName("pk_research_claims"); b.HasIndex("ResearchProjectId").HasDatabaseName("IX_research_claims_ResearchProjectId"); b.HasIndex("WorkspaceId", "ResearchProjectId").HasDatabaseName("ix_research_claims_workspace_id_project_id"); b.ToTable("research_claims");
        });
